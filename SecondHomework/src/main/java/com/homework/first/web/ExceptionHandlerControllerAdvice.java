...
public class ExceptionHandlerControllerAdvice {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> handleException(InvalidPermissions exception){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ErrorResponse(HttpStatus.FORBIDDEN, exception.getMessage()));
    }
}
